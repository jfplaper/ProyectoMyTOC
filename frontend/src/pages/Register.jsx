            ...
            <div className="bg-white p-8 rounded shadow-lg w-96">
                <form className="max-w-md mx-auto bg-white p-6 rounded-xl" onSubmit={handleSubmit}>
                    <div className="flex flex-col gap-2">
                        <h1 className="text-2xl font-bold mb-6 text-center text-[#2ABF7A]">
                            Registro de usuario
                        </h1>
                        ...
                        <input className="p-2 mb-4 border-gray-200 border rounded-lg focus:outline-[#2AB7FA]" 
                            type="password" placeholder="Password (mín. 6 dígitos)" 
                        ...
                        <Link to="/" className="font-bold center mx-auto underline">
                            Volver al inicio
                        </Link>
                    </div>
                </form>
