      ...
      <section className="h-full w-2xl my-4 mx-auto">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="text-xl text-justify">
            Para informarte del funcionamiento de nuestra aplicación web de registros de TOC, <Link to="/mytocappmanual" className="text-[#2AB7FA] underline hover:text-blue-700">mytocAPP</Link>, pulsa en el enlace. Si lo que buscas es 
