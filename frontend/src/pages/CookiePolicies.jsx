...
const CookiePolicies = () => {
    return (
        <div className="flex flex-col justify-center items-center mx-24">
            <h2 className="text-3xl font-light text-[#2ABF7A] mt-12 mb-6">AVISO LEGAL</h2>
            <div className="grid grid-cols-1 gap-6 p-4">
                ...
                <p>
                    ...
                    <a href="https://mpt.gob.es/ministerio/proteccion-datos/normativa.html">Más información</a>.
                </p>
